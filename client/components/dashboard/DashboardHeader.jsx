...
// circular account avatar on the right. The bell and account menu are the
// app's existing components — the shell renders them inside a light theme
// scope so they match this UI.
