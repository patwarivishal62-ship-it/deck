  ...
  return (
    <>
      ...
      <button
        ...
        aria-label="Open Echo, Deck's voice assistant"
      >
        <Mic size={24} />
            ...
            <div className="flex items-center justify-between border-b border-line bg-card px-5 py-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-text-soft">Deck's voice assistant — speak to create tasks, goals, notes & assign work</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <button
                  ...
                  <div className="flex-1 overflow-y-auto p-5">
                    {parsedActions.length === 0 ? (
                      <div className="flex flex-col items-center justify-center py-8 text-center">
                        ...
                        <p className="mt-3 text-sm font-medium text-text">Echo is listening-ready</p>
